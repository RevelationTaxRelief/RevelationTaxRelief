      ...
      <section className="border-t border-border bg-secondary/30">
        <div className="mx-auto max-w-7xl px-6 py-20 lg:px-8">
          <h2 className="text-3xl font-bold tracking-tight text-foreground text-center mb-16">
            Our Areas of Expertise & Operational Standards
          </h2>
      ...
      <section className="mx-auto max-w-7xl px-6 py-20 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
          {[
            ...
            {
              quote: "Revelation Tax Relief is professional, organized, and genuinely focused on helping clients understand their situation.",
              author: "Sarah M.",
              role: "Client since 2025",
            },
          ].map((testimonial) => (
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            {[
              ...
              >
                ...
                <p className="font-semibold text-foreground text-sm uppercase tracking-wide">{item.label}</p>
              </div>
            ))}
          </div>
        </div>
